...
@class SharedMockResponse, SharedMockResponseCompanion, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)mockRequestAPIOnSuccess:(void (^)(NSArray<SharedMockResponse *> *))onSuccess onError:(void (^)(NSString *))onError completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("mockRequestAPI(onSuccess:onError:completionHandler:)")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MockResponse")))
@interface SharedMockResponse : SharedBase
...
@property (class, readonly, getter=companion) SharedMockResponseCompanion *companion __attribute__((swift_name("companion")));
- (SharedMockResponse *)doCopyId:(int32_t)id name:(NSString *)name __attribute__((swift_name("doCopy(id:name:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MockResponse.Companion")))
@interface SharedMockResponseCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedMockResponseCompanion *shared __attribute__((swift_name("shared")));
